<template>
  ...
  <p style="display: flex">
    <Btn mode="line" type="primary" @click="showLoading = !showLoading">
      加载中
    </Btn>

    <Loading :show="showLoading" size="20px" color="var(--w-color-font-2)" />
  </p>
  <p style="margin-top: 450px">
    <Choose v-model="supplierId2" clearable block>
      <Choose.item
